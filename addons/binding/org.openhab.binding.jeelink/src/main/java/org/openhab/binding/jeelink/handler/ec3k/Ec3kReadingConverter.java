 ...
 */
public class Ec3kReadingConverter extends JeeLinkReadingConverter<Ec3kReading> {
    ...
    @Override
    protected Ec3kReading createReading(String inputLine) {
        if (listenerIdMap.size() > 0 && inputLine != null) {
    ...
    @Override
    public boolean convertsTo(Class<?> clazz) {
        return Ec3kReading.class.equals(clazz);
    }
}
