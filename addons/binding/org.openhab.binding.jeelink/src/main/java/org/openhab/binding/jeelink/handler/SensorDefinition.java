...
import org.openhab.binding.jeelink.handler.ec3k.Ec3kSensorDefinition;
import org.openhab.binding.jeelink.handler.lacrosse.LaCrosseSensorDefinition;
    ...
    public static ArrayList<JeeLinkReadingConverter<?>> createConverters(final JeeLinkHandler handler,
        ...
        if (converters == null) {
            ...
            for (SensorDefinition<?> sensor : SENSOR_DEFS) {
                if (sensor.getSketchName().equals(sketchName)) {
