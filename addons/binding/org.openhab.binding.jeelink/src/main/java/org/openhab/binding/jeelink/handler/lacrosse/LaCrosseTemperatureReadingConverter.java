 ...
 */
public class LaCrosseTemperatureReadingConverter extends JeeLinkReadingConverter<LaCrosseTemperatureReading> {
    ...
    public boolean convertsTo(Class<?> clazz) {
        return LaCrosseTemperatureReading.class.equals(clazz);
    }
}
